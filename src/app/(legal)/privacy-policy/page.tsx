...
export default function PrivacyPolicyPage() {
    return (
      <div>
        <h1>Privacy Policy for Nexaris Media</h1>
        <p>Last updated: {new Date().toLocaleDateString()}</p>
        
        <h2>Introduction</h2>
        <p>Welcome to Nexaris Media. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application.</p>
