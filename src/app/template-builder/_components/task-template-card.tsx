  ...
  return (
    <Card className="glassmorphic flex flex-col group">
      ...
      <CardContent className="flex-1 space-y-4">
        <div>
            <h4 className="text-sm font-semibold text-muted-foreground">Task Title</h4>
            <p>{template.taskName}</p>
        </div>
        {template.taskDescription && (
            <div>
                <h4 className="text-sm font-semibold text-muted-foreground">Task Description</h4>
                <p className="text-sm text-muted-foreground line-clamp-3">{template.taskDescription}</p>
            </div>
        )}
