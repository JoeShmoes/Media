...
export function AddTaskDialog({ onAddTask, groups }: { onAddTask: (task: Omit<Task, 'id' | 'completed'>, groupId: string) => void, groups: TaskGroup[] }) {
  ...
  const onSubmit = (data: TaskDialogFormValues) => {
    ...
    onAddTask(finalTaskData, groupId || "default");
    form.reset();
    setOpen(false);
  }
